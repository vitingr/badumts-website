    ...
    <header className="fixed bg-blue-900 w-full flex justify-center p-4 z-50 border-b border-[#D8DDE8]">
      <nav className="max-w-[1950px] bg-transparent w-full flex sm:justify-between sm:gap-12">
        ...
        <ul className="list-none hidden sm:flex justify-center w-full gap-10 items-center">
          <Link
            href={"/"}
            className="text-base text-white transition-all duration-300 hover:text-sky-500 px-4 py-1 rounded-xl"
          >
            Home
          </Link>
          <Link
        ...
        <div className="w-full flex sm:justify-center justify-end items-center gap-8">
          <Link
            href={"/sign-in"}
            className="text-white cursor-pointer sm:text-base text-sm transition-all duration-300"
          >
            Login
          </Link>
          <Link
            href={"/sign-up"}
            className="bg-white text-blue-900 rounded-lg text-center py-2 sm:px-4 px-2 cursor-pointer sm:text-base text-sm transition-all duration-300 hover:bg-blue-900 hover:text-white"
          >
            Create Account
          </Link>
        </div>
