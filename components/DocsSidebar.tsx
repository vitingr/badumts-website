...
const DocsSidebar = () => {
  return (
    <div className="sm:max-h-[82vh] overflow-y-scroll w-full max-w-[300px] px-8">
      <ul className="list-none border-b border-[#D8DDE8] pb-4">
      ...
      <ul className="list-none border-b border-[#D8DDE8] py-4 my-4">
        ...
        <li className="flex gap-4 items-center transition-all duration-300 cursor-pointer py-1 px-2 rounded-xl hover:bg-[#F0F4F9]">
          ...
          <p className="font-500 text-[#626B7F]">Componentes</p>
        </li>
        <li className="flex gap-4 items-center transition-all duration-300 cursor-pointer py-1 px-2 rounded-xl hover:bg-[#F0F4F9]">
          <GrHelpBook className="gray-icon cursor-default" size={14} />
          <p className="font-500 text-[#626B7F]">Manual</p>
        </li>
      </ul>
      <ul className="list-none border-b border-[#D8DDE8] py-4 my-4">
        ...
        <li className="flex gap-4 items-center transition-all duration-300 cursor-pointer py-1 px-2 rounded-xl hover:bg-[#F0F4F9]">
          ...
          <p className="font-500 text-[#626B7F]">Conexões</p>
        </li>
        <li className="flex gap-4 items-center transition-all duration-300 cursor-pointer py-1 px-2 rounded-xl hover:bg-[#F0F4F9]">
          <LuCombine className="gray-icon cursor-default" size={14} />
          <p className="font-500 text-[#626B7F]">Integrações</p>
        </li>
        <li className="flex gap-4 items-center transition-all duration-300 cursor-pointer py-1 px-2 rounded-xl hover:bg-[#F0F4F9]">
      ...
      <ul className="list-none border-b border-[#D8DDE8] py-4 my-4">
        ...
        <li className="flex gap-4 items-center transition-all duration-300 cursor-pointer py-1 px-2 rounded-xl hover:bg-[#F0F4F9]">
          ...
          <p className="font-500 text-[#626B7F]">Guia</p>
        </li>
        <li className="flex gap-4 items-center transition-all duration-300 cursor-pointer py-1 px-2 rounded-xl hover:bg-[#F0F4F9]">
          <MdOutlineSupportAgent
            ...
            size={14}
          />
          <p className="font-500 text-[#626B7F]">Suporte</p>
        </li>
        <li className="flex gap-4 items-center transition-all duration-300 cursor-pointer py-1 px-2 rounded-xl hover:bg-[#F0F4F9]">
          <IoChatbubbleEllipsesOutline
            className="gray-icon cursor-default"
            size={14}
          />
          <p className="font-500 text-[#626B7F]">Blog</p>
        </li>
      </ul>
      <ul className="list-none border-b border-[#D8DDE8] py-4 my-4">
